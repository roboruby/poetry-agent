...
module Poetry
  module Agent
    ...
    class MCPServerTest < Minitest::Test
      ...
      def server
        catalog = Poetry::Core::Check::Catalog.new(ENTRIES, helper_entries: HELPER_ENTRIES,
                                                            icon_names: %w[circle-alert triangle-alert])
        MCP::Server.new(entries: ENTRIES, catalog: catalog)
      end
      ...
      def with_blocks_server
        ...
        Dir.mktmpdir("agent-blocks") do |dir|
          ...
          catalog = Poetry::Core::Check::Catalog.new(ENTRIES, helper_entries: HELPER_ENTRIES)
          yield MCP::Server.new(entries: ENTRIES, catalog: catalog, blocks: BLOCKS, root: dir)
        end
      end
      ...
      def test_initialize_advertises_protocol_and_server_info
        ...
        assert_equal MCP::PROTOCOL_VERSION, result["protocolVersion"]
      ...
      def test_list_recipes_teaches_the_channel_and_empty_registries_say_so
        ...
        catalog = Poetry::Core::Check::Catalog.new(ENTRIES, helper_entries: HELPER_ENTRIES)
        server = MCP::Server.new(entries: ENTRIES, catalog: catalog, recipes: recipes)
      ...
      def with_build_server
        ...
        Dir.mktmpdir("agent-build") do |dir|
          ...
          catalog = Poetry::Core::Check::Catalog.new(ENTRIES, helper_entries: HELPER_ENTRIES,
                                                              icon_names: %w[circle-alert triangle-alert])
          yield MCP::Server.new(entries: ENTRIES, catalog: catalog, blocks: BLOCKS,
      ...
      def skills_server
        ...
        catalog = Poetry::Core::Check::Catalog.new(ENTRIES, helper_entries: HELPER_ENTRIES)
        [MCP::Server.new(entries: ENTRIES, catalog: catalog, skills: skills), counter]
      end
